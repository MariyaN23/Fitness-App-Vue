import type { IExerciseDescriptions, IGymHealthFacts, IWorkoutProgram } from "../types/workout.types.ts";

export const workoutProgram: IWorkoutProgram = {
    0: {  // Push
        warmup: [
...
export const exerciseDescriptions: IExerciseDescriptions = {
...
export const gymHealthFacts: IGymHealthFacts = [
